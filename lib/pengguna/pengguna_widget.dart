...
class PenggunaWidget extends StatefulWidget {
  const PenggunaWidget({Key key}) : super(key: key);

  @override
  _PenggunaWidgetState createState() => _PenggunaWidgetState();
}

class _PenggunaWidgetState extends State<PenggunaWidget> {
                                                                        ...
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            valueOrDefault<String>(
                                                                              dekanantPenggunaRecord.urutanData.toString(),
                                                                              'Tidak ada pesan',
                                                                            ),
                                                                            style: FlutterFlowTheme.of(context).bodyText1.override(
                                                                                  fontFamily: 'Poppins',
                                                                      ...
                                                                      children: [
                                                                        Expanded(
                                                                          child:
                                                                              Text(
                                                                            valueOrDefault<String>(
                                                                              prodiPenggunaRecord.urutanData.toString(),
                                                                              'Tidak ada pesan',
                                                                            ),
                                                                            style: FlutterFlowTheme.of(context).bodyText1.override(
                                                                                  fontFamily: 'Poppins',

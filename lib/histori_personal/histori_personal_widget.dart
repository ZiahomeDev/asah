...
class HistoriPersonalWidget extends StatefulWidget {
  const HistoriPersonalWidget({Key key}) : super(key: key);

  @override
  _HistoriPersonalWidgetState createState() => _HistoriPersonalWidgetState();
}

class _HistoriPersonalWidgetState extends State<HistoriPersonalWidget> {
    ...
    _pagingController.addPageRequestListener((nextPageMarker) {
      queryKehadiranRecordPage(
        queryBuilder: (kehadiranRecord) => kehadiranRecord
            .where('pengguna', isEqualTo: currentUserReference)
